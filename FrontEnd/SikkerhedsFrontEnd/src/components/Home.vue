    ...
    <aside class="sidebar">
      <div class="brand">
        ...
        <span class="brand-name"
          ><span class="brand-accent">Vision</span> Monitor</span
        >
      </div>
        ...
        <article class="stat-card">
          ...
          <div class="stat-body">
            ...
            >
              ...
              <span v-if="pingResult" style="font-size: 0.8rem; opacity: 0.8">{{
                pingResult
              }}</span>
            </div>
          </div>
        ...
        <div class="panel">
          ...
          <div class="health-list">
            ...
            <div class="health-row">
              ...
              <span
                class="health-pill"
                :class="telegramStatus.connected ? 'pill-green' : 'pill-red'"
              >
                <svg
                  width="10"
                  height="10"
      ...
      <section class="dash-section">
        ...
        <div class="dash-grid">
          ...
          <div class="dash-card">
            ...
            <div class="ctrl-grid">
              <button class="ctrl-btn c-green" @click="onControl('/on')">
                /on System On
              </button>
              <button class="ctrl-btn c-red" @click="onControl('/off')">
                /off System Off
              </button>
              <button class="ctrl-btn" @click="onControl('/status')">
                /status Check Status
              </button>
              <button class="ctrl-btn c-ghost" @click="onControl('/help')">
                /help Get Commands
              </button>
            </div>
          </div>
...
.home-dashboard {
  ...
  --c-green-t: #4ade80;
  --c-yellow: #f59e0b;
  --c-yellow-bg: rgba(245, 158, 11, 0.12);
  --c-yellow-t: #fcd34d;
  --c-orange: #f97316;
  --c-orange-bg: rgba(249, 115, 22, 0.14);
  --c-teal: #14b8a6;
  --c-teal-bg: rgba(20, 184, 166, 0.14);
  --c-indigo: #818cf8;
  --c-indigo-bg: rgba(129, 140, 248, 0.14);
  --c-purple: #a855f7;
  --c-purple-bg: rgba(168, 85, 247, 0.14);
  --c-red: #f87171;
  --c-red-bg: rgba(248, 113, 113, 0.14);
  --c-blue: #60a5fa;
...
.c-green {
  color: var(--c-green-t) !important;
}
.c-yellow {
  color: var(--c-yellow-t) !important;
}
.c-teal {
