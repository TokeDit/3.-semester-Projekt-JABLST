...
namespace TestAPI
{
    public class TestImgClass
    {
        ...
        public void ImageDataBase64_Get_ReturnsEmptyString_WhenImageDataIsEmpty()
        {
            ...
            // Act
            var result = image.ImageDataBase64;
        ...
        public void ImageDataBase64_Set_SetsImageDataFromBase64String()
        {
            ...
            // Act
            image.ImageDataBase64 = base64String;

            // Assert
            Assert.Equal(testBytes, image.ImageData);
        }
        ...
        public void ImageDataBase64_Set_SetsEmptyArray_WhenValueIsEmptyString()
        {
            ...
            // Act
            image.ImageDataBase64 = string.Empty;
        ...
        public void Image_InitializesWithDefaultValues()
        {
            ...
            // Assert
            Assert.Equal(string.Empty, image.TimeStamp);
        ...
        public void Image_Properties_CanBeSetAndRetrieved()
        {
            ...
            Assert.Equal(testTimestamp, image.TimeStamp);
        ...
        public void ImageDataBase64_RoundTrip_PreservesData()
        {
            ...
            // Act
            image.ImageData = originalBytes;
            var base64 = image.ImageDataBase64;
            var newImage = new Image { ImageDataBase64 = base64 };

            // Assert
            Assert.Equal(originalBytes, newImage.ImageData);
        }
    }
}
