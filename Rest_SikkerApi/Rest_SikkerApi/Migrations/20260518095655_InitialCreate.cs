    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OwnerUid = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    TelegramChatId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ReportFrequency = table.Column<int>(type: "int", nullable: false),
                    ReportEnabled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
